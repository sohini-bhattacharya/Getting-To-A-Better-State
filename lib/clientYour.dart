...
class clientYour extends StatefulWidget {
  const clientYour({Key? key}) : super(key: key);

  @override
  _clientYourState createState() => _clientYourState();
}

class _clientYourState extends State<clientYour> {
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return ListTile(
                        ...
                        title: Text(clientList[index],textAlign: TextAlign.left,
